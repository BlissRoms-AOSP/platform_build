...
$(combo_2nd_arch_prefix)TARGET_arm_CFLAGS := $(BENZO_CFLAGS_ARM)

# Modules can choose to compile some source as thumb.
$(combo_2nd_arch_prefix)TARGET_thumb_CFLAGS := $(BENZO_CFLAGS_THUMB) 
...
$(combo_2nd_arch_prefix)TARGET_GLOBAL_CFLAGS += $(BENZO_CFLAGS)
$(combo_2nd_arch_prefix)TARGET_GLOBAL_CPPFLAGS += $(BENZO_CPPFLAGS)
$(combo_2nd_arch_prefix)TARGET_GLOBAL_LDFLAGS += $(BENZO_LDFLAGS)
